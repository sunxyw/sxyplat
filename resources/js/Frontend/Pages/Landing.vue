                ...
                <div class="-mx-4 flex flex-wrap items-center">
                    <div class="w-full px-4">
                        ...
                        >
                            ...
                            >
                                {{ __('Integrate your Minecraft server with 10+ platforms') }}
                            </h1>
                            <p
        ...
        <section class="pt-20 pb-8 lg:pt-[120px] lg:pb-[70px]">
            <div class="container">
                ...
                <div class="-mx-4 flex flex-wrap">
                    ...
                    <FeatureCard title="Multipurpose Template"
                                 description="Lorem Ipsum is simply dummy text of the printing and industry.">
                        <template #icon>
                            <svg
                                width="35"
                    ...
                    <FeatureCard title="High-quality Design"
                                 description="Lorem Ipsum is simply dummy text of the printing and industry.">
                        <template #icon>
                            <svg
                                width="35"
                    ...
                    <FeatureCard title="All Essential Elements"
                                 description="Lorem Ipsum is simply dummy text of the printing and industry.">
                        <template #icon>
                            <svg
                                width="35"
        ...
        >
            <div class="container">
                ...
                <div class="flex flex-wrap items-center justify-center">
                    <PricingCard title="title" price="PRICE" :features="['feature']">
                        <template #addition>
                            <span
                    ...
                    <PricingCard title="title" price="PRICE" :features="['feature']" promotion="pioneer" promoted>
                    </PricingCard>
                    <PricingCard title="title" price="PRICE" :features="['feature']">
                        <template #addition>
                            <span
