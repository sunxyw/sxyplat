...
const showExtendedForm = computed(() => {
    ...
    delete errors.email;
    return props.emailLocked || Object.keys(errors).length > 0;
});
</script>

<template>
    <Frontend>
        <Banner title="SignUp"></Banner>
                            ...
                            <form @submit.prevent="submit">
                                ...
                                <template v-if="showExtendedForm">
                                    <div class="mb-6">
                                        <input
                                            type="text"
                                            :placeholder="__('Email Verify Code')"
                                            class="border-[#E9EDF4] w-full rounded-md border bg-[#FCFDFE] py-3 px-5 text-base text-body-color placeholder-[#ACB6BE] outline-none transition focus:border-primary focus-visible:shadow-none"
                                    ...
                                    <div class="mb-6">
                                        <input
                                            type="text"
                                            :placeholder="__('Organization ID')"
                                            class="border-[#E9EDF4] w-full rounded-md border bg-[#FCFDFE] py-3 px-5 text-base text-body-color placeholder-[#ACB6BE] outline-none transition focus:border-primary focus-visible:shadow-none"
                                            v-model="form.id"
                                        />
                                    </div>
